...
mapRegion <- function(matrizInput,titulo="",paleta="YlOrRd",  borda="black", hachura="blue", densidade_hachura=10, angulo_hachura=45)
  {
  ...
  Regioes <- readShapePoly(fn='/RProjetos/Mapas/regioes_2010.shp')
  regiaoEscolhida = Regioes
  
  regiaoEscolhida$sigla = as.character(regiaoEscolhida$sigla)
